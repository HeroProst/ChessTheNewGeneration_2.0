...
public class Cell
{
   ...
   public bool IsEnabled
    ...
    public Figure CurrentFigure 
    {
      ...
      set
      {
            if (value != null)
            {
                ...
                {
                    if(value.FigureType == Figure.TypesOfFigure.Pawn)
                        currentFigure.DeleteAllClones();
                    else
                        currentFigure.DeleteAllCloneExeptSelf();
                }
                value.XPos = XPos;
                value.YPos = YPos;
                Color cellColor;
    ...
    public void AllowCellToMove(List<Cell> cellsToMove, Figure.TypesOfFigure specialRequest = Figure.TypesOfFigure.None)
	{
    ...
    public void AllowCellToMoveAnyway(List<Cell> cellsToMove)
    {
        if (this.GetLinckedCell() == null)
            return;
        if(StaticDataContainer.HintEnabled)
        {
